...
export default function Map() {
  ...
  useEffect(() => {
    ...
    if (!apiKey) {
      setError('Lägg till VITE_GOOGLE_MAPS_API_KEY i .env.local för att visa kartan.')
      return
    }
    ...
    loadGoogleMaps(apiKey)
      ...
      .catch((e) => {
        console.error(e)
        setError('Kunde inte ladda Google Maps. Kontrollera API-nyckeln och nätverket.')
      })
